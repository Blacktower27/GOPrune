...
from .clip_encoder import CLIPVisionTower_GOPrune
...
def goprune(model, k=25,c=2,r=2,m=6,q=3):
    # exit()
    apply_info(model.model.vision_tower.vision_tower, k=k,c=c,r=r,m=m,q=q)
    ...
    CLIPVisionTower.forward = CLIPVisionTower_GOPrune.forward
